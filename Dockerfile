...
COPY --from=nexus3.o-ran-sc.org:10004/o-ran-sc/bldr-alpine3-rmr:4.6.0 /usr/local/lib64/librmr* /usr/local/lib64/
# RMR setup
RUN mkdir -p /opt/route/
COPY config/test_route.rt /opt/route/test_route.rt
...
ENV CONFIG_FILE=/tmp/config/config-file.json
